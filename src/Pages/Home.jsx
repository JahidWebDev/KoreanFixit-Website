...
const products = [
  {
    id: 1,
    title: "Waterproofing",
    desc: "Concrete waterproofing is the process of applying specialized waterproofing systems on concrete structures to stop water infiltration, reduce dampness, and enhance structural durability.",
    img: product1,
  },
  {
    id: 2,
    title: "Water Reducing",
    desc: "Water Reducing Admixture is designed to reduce the water content in concrete while maintaining workability, resulting in higher strength, improved durability, and better finish.",
    img: product2,
  },
  {
    id: 3,
    title: "Damp Protect",
    desc: "Damp Protect is a specialized treatment designed to prevent moisture penetration in walls and concrete surfaces, protecting structures from dampness, stains, and long-term damage.",
    img: product3,
  },
];
      ...
      <section className="bg-[#f8f9fb] py-24">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 px-4">
          ...
          <p className="mt-4 text-gray-500 leading-relaxed">
            We provide high-quality services, innovative strategies, and
            reliable support to help businesses grow faster and build a strong
            digital presence.
          </p>
        </div>
