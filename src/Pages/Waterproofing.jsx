                    ...
                    <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 animate-fadeIn">
                      ...
                      >
                        <input
                          ...
                          required
                          className="w-full bg-gray-50 border border-[#1F1954]/30 px-4 py-3 rounded-lg text-[#1F1954] placeholder:text-gray-500 focus:bg-white focus:border-[#1F1954] focus:ring-2 focus:ring-[#1F1954]/30 outline-none transition-all duration-300"
                        />
                        <input
                          type="email"
                          name="email"
                        ...
                        <textarea
                          ...
                          onChange={handleChange}
                          required
                          className="w-full bg-gray-50 border border-[#1F1954]/30 px-4 py-3 rounded-lg h-28 resize-none text-[#1F1954] placeholder:text-gray-500 focus:bg-white focus:border-[#1F1954] focus:ring-2 focus:ring-[#1F1954]/30 outline-none transition-all duration-300"
                        />
                        <button
                          type="submit"
                          className="w-full py-3 rounded-lg font-semibold text-white bg-[#1F1954] hover:bg-[#2a2370] hover:shadow-lg active:scale-95 transition-all duration-300"
                        >
                          Submit Application
                        </button>
                      </form>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {[
                      ...
                      "Effective barrier against sulphates, chlorides, and carbonation",
                    ...
                    <tr>
                      ...
                      <td className="p-3 border">
                        ...
                        <span className="text-xs text-gray-500">
                          (Actual dosage may vary depending on mix design and site
                          requirements.)
                        </span>
                      </td>
                    </tr>
